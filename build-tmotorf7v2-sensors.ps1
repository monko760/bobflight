...
Write-Host 'Expected firmware: 0.2.0-prototype-tmotorf7v2-sensor1; board tmotor_f7_v2.'
Write-Host 'Read TMOTORF7V2.md before installation. Motors, flight and F722 configuration saving are unavailable.'

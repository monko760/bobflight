...
#define BOBFLIGHT_VERSION_STRING "0.2.0-prototype-tmotorf7v2-sensor2-bl1-calstore1-piddiag1"
#else
#define BOBFLIGHT_VERSION_STRING "0.2.0-prototype-switchbench2-bl1-calstore1-piddiag1"
#endif

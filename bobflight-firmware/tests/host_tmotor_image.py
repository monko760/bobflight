...
def fixture(sp=0x20010000,reset=0x08000009,marker=b'tmotor_f7_v2\0' b'0.2.0-prototype-tmotorf7v2-sensor2-bl1\0'):
...
with tempfile.TemporaryDirectory() as td:
 ...
 def check(lines,valid,board="tmotor_f7_v2"):
  ...
  assert valid
 check(fixture(),True)
 holy=fixture(marker=b'kakute_f7_hdv\0' b'0.2.0-prototype-switchbench2-bl1\0')

...
- **Session-only:** UART and mode edits are held in RAM. Reboot resets them. The ordinary `save` command does not persist these assignments. Changes are refused while armed or while bench motor activity is present.
